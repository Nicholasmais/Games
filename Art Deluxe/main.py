...
width, height = screensize.current_w, screensize.current_h
aspect = width / height
...
test_font = pygame.font.Font(r"Art Deluxe\font\Pixeltype.ttf", 50)

sky_surface = pygame.image.load(r"Art Deluxe\graphics/Sky.png").convert()
sky_surface = pygame.transform.scale(sky_surface, (width,height))
ground_surface = pygame.image.load(r"Art Deluxe\graphics/Ground.png").convert()
...
snail_surface = pygame.image.load(r"Art Deluxe\graphics/chico_novo_jogo.png").convert_alpha()
...
player_surf = pygame.image.load(r"Art Deluxe\graphics/player/player_walk_1.png").convert_alpha()
